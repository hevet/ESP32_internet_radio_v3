...
#define SD_CS 47                  // Pin CS (Chip Select) dla karty SD
...
int maxVisibleLines = 9;          // Maksymalna liczba widocznych linii na ekranie OLED
...
U8G2_SSD1363_256X128_F_HW_I2C u8g2(U8G2_R0, /* reset=*/ U8X8_PIN_NONE, /* clock=*/ SCL_PIN, /* data=*/ SDA_PIN);
...
void setup()
{
  ...
  SPI.begin(SD_SCLK, SD_MISO, SD_MOSI, SD_CS);  // SCLK = 45, MISO = 21, MOSI = 48, CS = 47
